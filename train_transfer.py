...
class Graph:
    def __init__(self, num=1, mode="train"):
        ...
        if training:
            ...
            # tvars_new = [var for var in tvars if ('SSRN/C_13') in var.name] + \
            #          [var for var in tvars if ('SSRN/C_14') in var.name] + \
            #          [var for var in tvars if ('SSRN/C_15') in var.name] + \
            #          [var for var in tvars if ('SSRN/C_16') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/TextEnc/HC_11') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/TextEnc/HC_12') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/TextEnc/HC_13') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/TextEnc/HC_14') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/TextEnc/HC_15') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/AudioEnc/HC_9') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/AudioEnc/HC_10') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/AudioEnc/HC_11') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/AudioEnc/HC_12') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/AudioEnc/HC_13') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/AudioDec/HC_7') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/AudioDec/C_8') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/AudioDec/C_9') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/AudioDec/C_10') in var.name] + \
            #          [var for var in tvars if ('Text2Mel/AudioDec/C_11') in var.name] 
